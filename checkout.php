        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-1">
                        <a title="Paypal - Acesso Imediato ao Curso" href="paypal/checkout.php?id=<?php echo $id_mat; ?>&curso=<?php echo $id_curso; ?>" target="_blank"><img src="img/pagamentos/paypal.png" width="200"></a>
                    ...
                    <div class="col-md-4 col-sm-12 mb-1">
                        ...
                        $btn = $pagar->PagarMP($id_mat, $nome_do_curso, (float)$valor_mat, $url_site);
                        echo $btn;
                        ?>
