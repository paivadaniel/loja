                        ...
                        <div class="tab-pane" id="tabs-3" role="tabpanel">
                            <div class="product__details__tab__desc">
                                ...
                                <div class="mt-4">
                                    ...
                                    $query = $pdo->query("SELECT * from avaliacoes WHERE id_produto = '$id_combo' order by data desc");
                                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                    for ($i = 0; $i < count($res); $i++) {
                                        foreach ($res[$i] as $key => $value) {
                                        }
                                    ...
                                    ?>
                                            <div class="mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    ?>
                                                        <a href="combo.php?nome=<?php echo $produto_get ?>&acao=deletar&id_avaliacao=<?php echo $id_avaliacao ?>">
